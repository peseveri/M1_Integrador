...
FROM {{ ref('stg_detalle_ordenes') }} od -- O tu modelo de staging de detalles de órdenes
LEFT JOIN {{ ref('stg_ordenes') }} o ON od.orden_id = o.orden_id -- Si tienes una tabla de encabezado de órdenes